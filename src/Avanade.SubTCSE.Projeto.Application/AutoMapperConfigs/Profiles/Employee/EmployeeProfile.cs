...
namespace Avanade.SubTCSE.Projeto.Application.AutoMapperConfigs.Profiles.Employee
{
    public class EmployeeProfile : Profile
    {
        public EmployeeProfile()
        {
            ...
            {
                return new Avanade_SubTCSE_Projeto.Domain.Aggregates.Employee.Entities.Employee(
                    firstName: ctor.PrimeiroNome,
                    surName: ctor.Sobrenome,
                    birthday: ctor.Aniversario,
                    active: ctor.Ativo,
                    salary: ctor.Salario,
                    employeeRole: res.Mapper.Map<Avanade_SubTCSE_Projeto.Domain.Aggregates.EmployeeRole.Entities.EmployeeRole>(ctor.Cargo));
            })
